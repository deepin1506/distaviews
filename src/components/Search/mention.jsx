...
import DashMention1 from "../../img/dashborad/mentions1.png";
import DashMention2 from "../../img/dashborad/mentions2.png";
import DashMention3 from "../../img/dashborad/mentions3.png";
    ...
    <div className="main-content bg-blacks">
      ...
      <div className="dashboard-content">
        ...
        <div className="dashboard-right-content bg-img-none flex-grow-1">
          <div className="title-card d-flex align-items-center justify-content-between mb-20 flex-column flex-md-row">
            <div className="d-flex align-items-center">
              <div className="f-20 fw-700 f-lightwhite s-title">Mentions</div>
            </div>

            <div className="d-flex align-items-center flex-grow-1 justify-content-end  mb-3 mb-md-0 flex-column flex-sm-row pe-3 gap-2 gap-md-3">
          ...
          <div className="dashboard-inner-section">
            {/* <!-- mention content start --> */}
            <div className="mention-card">
              <div className="f-20 f-lightwhite fw-700">Mentions</div>
              <div className="mention-table-wrapper text-center">
                <div className="table-responsive">
                  <table
                    id="MentionTable"
                    className="table text-start w-100 mention-table mb-4"
                  >
                    <thead className="d-none">
                      <tr>
                        <th style={{ width: "100%" }}>table heading</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                          ...
                          >
                            <div className="mentions-main-content">
                              <div className="d-flex align-items-center gap-3">
                                ...
                                <span className="f-15 text-white fw-700 mx-150 text-truncate">
                                  Don Norman
                                </span>
                                <span className="f-15 f-gray mx-150 text-truncate">
                                  @wiljh23
                                </span>
                              </div>
                              <div className="f-15 f-gray mention-time">
                                23 Mar
                              </div>
                            </div>
